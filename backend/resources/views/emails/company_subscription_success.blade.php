        ...
        <div class="content">
            ...
            <div class="invoice-card">
                ...
                <div class="invoice-row">
                    ...
                    <span class="invoice-value">{{ $payment->resolvedMerchantOrderId() ?? $payment->razorpay_order_id }}</span>
                </div>
                <div class="invoice-row">
                    <span class="invoice-label">Payment ID</span>
                    <span class="invoice-value">{{ $payment->resolvedPaymentId() ?? $payment->razorpay_payment_id }}</span>
                </div>
