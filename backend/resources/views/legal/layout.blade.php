    ...
    <style>
        * { box-sizing: border-box; }
        body {
            ...
            color: #0f172a;
            background: {{ !empty($embed) ? '#ffffff' : '#f8fafc' }};
            line-height: 1.65;
        }
        .wrap { max-width: 900px; margin: 0 auto; padding: {{ !empty($embed) ? '12px 14px 40px' : '28px 16px 56px' }}; }
        .header {
        ...
        .card {
            background: #fff; border: {{ !empty($embed) ? '0' : '1px solid #e2e8f0' }}; border-radius: 14px;
            padding: {{ !empty($embed) ? '8px 4px' : '22px 20px' }};
        }
        h1 { margin: 0 0 8px; font-size: {{ !empty($embed) ? '24px' : '28px' }}; line-height: 1.25; }
        ...
        .notice {
            ...
            padding: 12px 14px; margin: 12px 0 4px; color: #9a3412; font-size: 14px;
        }
    </style>
</head>
<body>
