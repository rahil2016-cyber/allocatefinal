...
<head>
  ...
  <title>JobAllocate — Referral invite</title>
  <style>
    body {
      margin: 0;
      min-height: 100vh;
...
<body>
  <h1>You’re invited to JobAllocate</h1>
  <p>Use this referral code when you register to unlock refer &amp; earn benefits:</p>
  <div class="code">{{ $code }}</div>
  <p>If the app is installed it will open automatically. Otherwise download from Play Store, then enter the code on sign-up.</p>
  <p>
