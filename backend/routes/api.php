...
use App\Http\Controllers\Api\V1\CashfreeWebhookController;
...
Route::prefix('v1')->middleware('throttle:api')->group(function () {
    // Auth — leaky-bucket limits (login 10/min, OTP 5/30min). See config/leaky_bucket.php.
    Route::post('auth/admin-login', [AuthController::class, 'adminLogin'])
        ->middleware('leaky:login');
    Route::post('auth/send-otp', [AuthController::class, 'sendOtp'])
        ->middleware('leaky:otp');
    Route::post('auth/verify-otp', [AuthController::class, 'verifyOtp'])
        ->middleware('leaky:otp_verify');
    ...
    Route::post('payments/webhook', [CashfreeWebhookController::class, 'handle']);
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::prefix('admin')->middleware('role:super_admin')->group(function () {
            ...
            Route::get('settings/contact', [AdminSettingController::class, 'showContact']);
            Route::patch('settings/contact', [AdminSettingController::class, 'updateContact']);
