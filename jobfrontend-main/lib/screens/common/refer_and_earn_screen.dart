...
class _ReferAndEarnScreenState extends State<ReferAndEarnScreen>
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      if (!mounted) return;
      setState(() {
        _error = NetworkUserMessage.fullUserMessage(e);
        _loading = false;
      });
    }
  }
                  ...
                  child: ListView(
                    ...
                    children: [
                      if (_data['enabled'] != true)
                        ...
                        const SizedBox(height: 24),
                        if ((_data['invite_url']?.toString() ?? '').isNotEmpty) ...[
                          Text('Your invite link', style: tt.titleSmall?.copyWith(fontWeight: FontWeight.w800)),
                          const SizedBox(height: 8),
                          Text(
                            _data['invite_url'].toString(),
                            style: tt.bodySmall?.copyWith(color: AppColors.primary, fontWeight: FontWeight.w600),
                          ),
                          const SizedBox(height: 12),
                        ],
                        if (_data['play_store_coming_soon'] == true) ...[
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 8),
                                const Text(
                                  'Share your invite. Friends download from Play Store, then the code is auto-filled on Register (or they can type it).',
                                ),
                              ],
                            ),
                          ),
                          ...
                          SizedBox(
                            ...
                            child: FilledButton.icon(
                              ...
                              label: const Text('Open Play Store listing'),
                              style: FilledButton.styleFrom(
                                backgroundColor: AppColors.primary,
                                padding: const EdgeInsets.symmetric(vertical: 14),
                              ),
                        ...
                        const SizedBox(height: 12),
                        Text(
                          'Friends open your invite link → install from Play Store → Register with the code pre-filled (or enter it manually) to credit your referral.',
