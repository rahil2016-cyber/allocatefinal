...
class _JobDetailScreenState extends State<JobDetailScreen> {
  ...
  void _showReportJobDialog() {
    if (!AppSession.isLoggedIn) {
      _showError('Please log in to report a job posting');
      return;
    }

    String selectedReason = 'Spam / Fraud';
    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          ...
          title: const Text('Report Job Posting', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('Why are you reporting this job?', style: TextStyle(fontSize: 13, color: Colors.grey)),
              ...
              DropdownButtonFormField<String>(
                ...
                items: const [
                  DropdownMenuItem(value: 'Spam / Fraud', child: Text('Spam / Fraud')),
                  DropdownMenuItem(value: 'Misleading Information', child: Text('Misleading Information')),
                  DropdownMenuItem(value: 'Asking for Money', child: Text('Asking for Money / Scam')),
            ...
            ElevatedButton(
              ...
              onPressed: submitting
                  ...
                  : () async {
                      ...
                      try {
                        await JobSeekerApiService.instance.reportJob(
                          jobId: _job.id,
                        ...
                        if (mounted && ctx.mounted) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Job reported successfully. Our team will review it.'),
                        ...
                        if (mounted) {
                          _showError('Failed to report job: $e');
                        }
                      }
                    },
              child: submitting
                ...
                SliverAppBar(
                  ...
                  actions: [
                    ...
                    PopupMenuButton<String>(
                      icon: const Icon(Icons.more_vert_rounded, color: AppColors.textPrimary, size: 24),
                      onSelected: (value) {
                        if (value == 'report') {
                          _showReportJobDialog();
                        }
                      },
                      itemBuilder: (context) => [
                        const PopupMenuItem<String>(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 10),
                              Text('Report Job', style: TextStyle(color: Colors.red, fontWeight: FontWeight.w600)),
                            ],
                          ),
                        ),
                      ],
      ...
      builder: (ctx) {
        return StatefulBuilder(builder: (ctx, setModalState) {
          ...
          final availableHeight =
              MediaQuery.sizeOf(ctx).height - bottomInset;
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          const Text(
                            'Help us keep the platform safe. Your report is anonymous.',
                            style: TextStyle(
                              fontSize: 13,
                            ...
                            child: FilledButton(
                              onPressed: isSubmitting
                                  ...
                                  : () async {
                                      ...
                                      try {
                                        await JobSeekerApiService.instance
                                            .reportJob(
                                          jobId: _job.id,
                                          reason: selectedReason,
                                          description:
