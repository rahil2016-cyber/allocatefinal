...
class _JobSeekerPackagesScreenState extends State<JobSeekerPackagesScreen>
  ...
  /// Opens Cashfree checkout immediately — no confirmation dialog.
  Future<void> _purchase(Map<String, dynamic> row) async {
    ...
    try {
      final orderData =
          await JobSeekerApiService.instance.createCashfreeOrder(key);
      await CashfreePaymentService.instance.checkoutAndConfirm(
        orderData: orderData,
        confirmStatus: (merchantOrderId) =>
            JobSeekerApiService.instance.confirmCashfreePayment(
