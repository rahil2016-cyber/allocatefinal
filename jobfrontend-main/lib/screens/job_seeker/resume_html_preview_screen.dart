  ...
  Future<void> _onPurchaseAndDownload() async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'Pay ₹$kResumeHtmlPdfPriceInr to download “$label” as PDF via PhonePe.\n\n'
    ...
    try {
      final orderData = await JobSeekerApiService.instance.createResumePdfOrder(
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Payment successful. Opening PDF…'),
