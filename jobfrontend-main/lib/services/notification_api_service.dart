...
class AppNotification {
  ...
  String? get jobId {
    final fromField = data['job_id']?.toString() ??
        data['reference_id']?.toString() ??
        data['referenceId']?.toString();
    if (fromField != null && fromField.trim().isNotEmpty) return fromField.trim();
    return null;
  }
  ...
  factory AppNotification.fromJson(Map<String, dynamic> json) {
    ...
    final topJobId = json['job_id']?.toString();
    if (topJobId != null &&
        topJobId.isNotEmpty &&
        !data.containsKey('job_id')) {
      data['job_id'] = topJobId;
    }
